    ...
    <body
        ...
        <div
            ...
            <main class="flex max-w-[335px] w-full flex-col lg:max-w-4xl">
                <div class="w-full">
                    <h1 class="text-3xl font-bold mb-8 text-center dark:text-[#EDEDEC]">Cari Tiket Kereta Reguler</h1>

                    <form action="{{ route('list_ticket') }}" method="GET"
                        class="bg-white dark:bg-[#161615] p-8 rounded-lg shadow-lg border border-[#e3e3e0] dark:border-[#3E3E3A]">
                        @csrf

                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                            <!-- Origin -->
                            <div>
                                <label for="origin" class="block text-sm font-medium mb-2 dark:text-[#EDEDEC]">Stasiun
                                    Asal</label>
                                <select id="origin" name="origin" required
                                    class="w-full px-4 py-2 border border-[#e3e3e0] dark:border-[#3E3E3A] rounded-sm bg-white dark:bg-[#1b1b18] text-black dark:text-[#EDEDEC] focus:outline-none focus:border-[#1b1b18] dark:focus:border-[#eeeeec]">
                            ...
                            <div>
                                <label for="destination"
                                    class="block text-sm font-medium mb-2 dark:text-[#EDEDEC]">Stasiun Tujuan</label>
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                            ...
                            <div>
                                <label for="departure_date"
                                    class="block text-sm font-medium mb-2 dark:text-[#EDEDEC]">Tanggal Berangkat</label>
                                <input type="date" id="departure_date" name="departure_date" min="{{ date('Y-m-d') }}"
                                    max="{{ \Carbon\Carbon::now()->addDays(7)->format('Y-m-d') }}" required
                                    class="w-full px-4 py-2 border border-[#e3e3e0] dark:border-[#3E3E3A] rounded-sm bg-white dark:bg-[#1b1b18] text-black dark:text-[#EDEDEC] focus:outline-none focus:border-[#1b1b18] dark:focus:border-[#eeeeec]">
                            </div>
                            ...
                            <div>
                                <label for="return_date"
                                    class="block text-sm font-medium mb-2 dark:text-[#EDEDEC]">Tanggal Pulang
                                    (Opsional)</label>
                            ...
                            <div>
                                <label for="passengers"
                                    class="block text-sm font-medium mb-2 dark:text-[#EDEDEC]">Jumlah Penumpang</label>
                        ...
                        <div class="flex justify-center">
                            <button type="submit"
                                class="px-8 py-3 bg-[#1b1b18] dark:bg-[#eeeeec] text-white dark:text-[#1b1b18] rounded-sm font-medium hover:bg-black dark:hover:bg-white transition-all duration-300 shadow-md">
                                Cari Tiket
                            </button>
                        </div>
                    </form>
