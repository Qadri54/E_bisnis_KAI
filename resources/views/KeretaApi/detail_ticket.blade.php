                        ...
                        <div class="border-2 border-gray-300 p-4">
                            <div class="flex justify-between mb-3">
                                <div>
                                    ...
                                    <div class="text-sm text-gray-600">
                                        {{ $departureTicket->destinasi->destinasi_asal }} - {{ $departureTicket->destinasi->destinasi_tujuan }}
                                    </div>
                                </div>
                                <div class="text-right">
                                    <div class="font-bold text-lg">Rp {{ number_format($departureTicket->harga_tiket, 0, ',', '.') }}</div>
                            ...
                            <div class="grid grid-cols-2 gap-4 text-sm pt-3 border-t">
                                <div>
                                    ...
                                    <div class="font-medium">{{ $departureTicket->jadwalKereta->jadwal_keberangkatan->format('d M Y') }}</div>
                                </div>
                                <div>
                            ...
                            <div class="border-2 border-gray-300 p-4">
                                <div class="flex justify-between mb-3">
                                    <div>
                                        ...
                                        <div class="text-sm text-gray-600">
                                            {{ $returnTicket->destinasi->destinasi_asal }} - {{ $returnTicket->destinasi->destinasi_tujuan }}
                                        </div>
                                    </div>
                                    <div class="text-right">
                                        <div class="font-bold text-lg">Rp {{ number_format($returnTicket->harga_tiket, 0, ',', '.') }}</div>
                                        <div class="text-xs text-gray-500">/person</div>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-2 gap-4 text-sm pt-3 border-t">
                                    <div>
                                        <div class="text-gray-600 text-xs">DATE</div>
                                        <div class="font-medium">{{ $returnTicket->jadwalKereta->jadwal_keberangkatan->format('d M Y') }}</div>
                                    </div>
                                    <div>
                                        <div class="text-gray-600 text-xs">TIME</div>
                                        <div class="font-medium">
                ...
                <div class="bg-white border-2 border-gray-900 p-6 sticky top-6">
                    ...
                    <div class="space-y-2 mb-4 text-sm">
                        <div class="flex justify-between">
                            ...
                            <span class="font-mono">Rp {{ number_format($departureTicket->harga_tiket * $passengers, 0, ',', '.') }}</span>
                        </div>

                        @if($returnTicket)
                            <div class="flex justify-between">
                                <span class="text-gray-600">Return ({{ $passengers }}x)</span>
                                <span class="font-mono">Rp {{ number_format($returnTicket->harga_tiket * $passengers, 0, ',', '.') }}</span>
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="border-t-2 border-gray-900 pt-4 mb-6">
                        <div class="flex justify-between items-center">
                            ...
                            <div class="text-right">
                                <div class="font-bold text-2xl font-mono">Rp {{ number_format($total, 0, ',', '.') }}</div>
